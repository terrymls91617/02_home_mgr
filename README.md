...
- 👤 **用户系统** - 支持用户注册、登录，管理员邀请码机制
- 🔐 **权限隔离** - 每个用户默认只能看到自己创建的账号
- 🤝 **账号共享** - 标记为共享的账号所有用户均可查看
- 📝 **账号管理** - 添加、编辑、删除账号信息
...
| ADMIN_PASSWORD | admin123456 | 管理员账号密码 |
| JWT_SECRET | home_mgr_default_secret_2024 | JWT 加密密钥 |
